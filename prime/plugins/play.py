...
from prime import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from prime.core.call import assistantcall
from prime.utils import seconds_to_min, time_to_seconds
from prime.utils.channelplay import get_channeplayCB
from prime.utils.database import is_video_allowed
from prime.utils.decorators.language import languageCB
from prime.utils.decorators.play import PlayWrapper
from prime.utils.formatters import formats
from prime.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from prime.utils.inline.playlist import botplaylist_markup
from prime.utils.logger import play_logs
from prime.utils.stream.stream import stream
    ...
    if audio_telegram:
        ...
        if await Telegram.download(_, message, mystic, file_path):
            ...
            try:
                ...
                await app.send_message(config.LOG_GROUP_ID, f"**>> ERROR ALERT**📌\n\n{ex_type}\n\n**Chat_ID** => {str(chat_id)}\n**Reported To** >> @Always_Genius")
        ...
        if await YouTube.exists(url):
            ...
            try:
                await assistantcall.stream_call(url)
                ...
                return await app.send_message(
                    config.LOG_GROUP_ID,
                    "ᴩʟᴇᴀsᴇ ᴛᴜʀɴ ᴏɴ ᴠɪᴅᴇᴏᴄʜᴀᴛ ᴛᴏ sᴛʀᴇᴀᴍ ᴜʀʟ. @Always_Genius",
                )
            except Exception as e:
                await app.send_message(config.LOG_GROUP_ID, f"**>> ERROR ALERT**📌\n\n{type(e).__name__}\n\n**Chat_ID** => {str(chat_id)}\n**Reported To** >> @Always_Genius")
                return await mystic.edit_text(
