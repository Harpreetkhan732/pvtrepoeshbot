...
from prime.utils import AdminRightsCheck
from prime.utils.database.memorydatabase import is_active_chat, is_nonadmin_chat
from prime.utils.decorators.language import languageCB
from prime.utils.inline.play import close_keyboard
from prime.utils.inline.speed import speed_markup
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    try:
        await assistantcall.speedup_stream(
            chat_id,
            file_path,
            speed,
            playing
