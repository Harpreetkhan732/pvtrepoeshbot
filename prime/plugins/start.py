...
from prime import Telegram, YouTube, app
from prime.misc import SUDOERS, _boot_
from prime.plugins.playlist import del_plist_msg
from prime.plugins.sudoers import sudoers_list
from prime.utils.database import (add_served_chat,
                                       add_served_user,
                                       get_served_chats,
                                       get_served_users,
                                       blacklisted_chats,
...
from prime.utils.decorators.language import LanguageStart
from prime.utils.formatters import get_readable_time
from prime.utils.inline import (help_pannel, private_panel,
                                     start_pannel)
            ...
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="• sᴜᴩᴩᴏʀᴛ •", url="https://t.me/Life_Codes"
                        ),
                    ],
                ]
            )
