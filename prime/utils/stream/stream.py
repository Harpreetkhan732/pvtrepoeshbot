...
import config
from prime import Carbon, YouTube, app
from prime.core.call import assistantcall
from prime.misc import db
from prime.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from prime.utils.exceptions import AssistantErr
from prime.utils.inline.play import (stream_markup, queue_markup,
                                          telegram_markup)
from prime.utils.inline.playlist import close_markup
from prime.utils.pastebin import Ayushbin
from prime.utils.stream.queue import put_queue, put_queue_index
from prime.utils.thumbnails import gen_thumb, gen_qthumb
...
async def stream(
    ...
    if forceplay:
        await assistantcall.force_stop_stream(chat_id)
